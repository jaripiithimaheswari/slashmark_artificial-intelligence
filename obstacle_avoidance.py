...
# Attempt to import ultralytics YOLO. If unavailable, exit with a clear message.
try:
    from ultralytics import YOLO
except Exception:
    print("Error: 'ultralytics' package or YOLO model could not be imported. Install it with 'pip install ultralytics'.")
    sys.exit(1)
